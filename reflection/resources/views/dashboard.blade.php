        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flexy-boy p-6 bg-white border-b border-gray-200">
                    ...
                    <button onclick="return AddNewCompanyorEmployeeModal();" class="add-new-btn">Add new business</button>
                </div>
                <table class="comp-table-cont">
                    ...
                    <tr class="clean">
                        ...
                        <td class="button-table"><a href="/companies/{{$company['id'] }}/Details" class="table-btn read"><i class="far fa-eye"></i></a>  <a onclick="return myFunction();" href="{{url('delete/'.$company['id']) }}" class="table-btn delete"><i class="fas fa-trash"></i></a></td>
                    </tr>
                    @endforeach
                </table>
            </div> 
            ...
            <div class="modal no-display">
                ...
                <div class="modal-form">
                    <form method="POST" class="add-company-form" action="companies/store" enctype="multipart/form-data">
                        ...
                        <input class="company-logo" type="file" name="logo" required="required">
